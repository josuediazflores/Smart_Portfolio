...
export const metadata: Metadata = {
  title: "Josue Diaz Flores - My Smart portfolio",
};
    ...
    <section className="space-y-16 bg-[url('/background.png')] bg-cover bg-center bg-no-repeat px-1 py-8">
      <section className="grid grid-cols-1 items-center gap-8 sm:grid-cols-2">
        <div className="space-y-3">
          <H1 className="text-center sm:text-start">Hi, I&apos;m Josue 👋</H1>
          <p className="text-center sm:text-start">
            I&apos;m a Computer Science Student from San Jose, California
      ...
      <section className="space-y-3 text-center">
        ...
        <p>
          ...
          to the activate the AI chat. You can ask the chatbot any question
